...
public class Bear_MoveState : EnemyState
{
    ...
    public Bear_MoveState(Enemy _enemyBase, EnemyStateMachine _stateMachine, string _animBoolName,Enemy_Bear _enemy) : base(_enemyBase, _stateMachine, _animBoolName)
    {
