...
public class EliteSkeleton_StunnedState : EnemyState
{
    ...
    public EliteSkeleton_StunnedState(Enemy _enemyBase, EnemyStateMachine _stateMachine, string _animBoolName, EliteSkeleton_Enemy _enemy) : base(_enemyBase, _stateMachine, _animBoolName)
    {
        enemy = _enemy;
    }
