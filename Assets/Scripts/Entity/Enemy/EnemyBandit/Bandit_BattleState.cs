...
public class Bandit_BattleState : EnemyState
{
    ...
    public Bandit_BattleState(Enemy _enemyBase, EnemyStateMachine _stateMachine, string _animBoolName,Bandit_Enemy _enemy) : base(_enemyBase, _stateMachine, _animBoolName)
    {
        enemy = _enemy;
    }
