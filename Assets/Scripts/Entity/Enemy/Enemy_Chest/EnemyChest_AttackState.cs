...
public class EnemyChest_AttackState : EnemyState
{
    ...
    public EnemyChest_AttackState(Enemy _enemyBase, EnemyStateMachine _stateMachine, string _animBoolName,Chest_Enemy _enemy) : base(_enemyBase, _stateMachine, _animBoolName)
    {
        enemy = _enemy;
